...
<?php if(is_home()) : ?>
	...
	<section class="sec">
		<div class="container">
			...
			<p class="sec_btn">
				<a href="<?= get_term_link('news', 'category') ?>" class="btn btn-default">最新情報の一覧<i class="fas fa-angle-right"></i></a>
			</p>
	...
	<section class="sec bg-gray">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-6">
					<a href="<?= get_permalink(34) ?>" class="bnr" style="background-image: url('<?= get_template_directory_uri() ?>/assets/img/home/bnr_about@2x.jpg')">
						<div class="bnr_inner">
				...
				<div class="col-md-6">
					<a href="<?= get_permalink(43) ?>" class="bnr" style="background-image: url('<?= get_template_directory_uri() ?>/assets/img/home/bnr_access@2x.jpg')">
						<div class="bnr_inner">
